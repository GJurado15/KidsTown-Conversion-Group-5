// Word lists shared by Word Fun (hangman) and Scramble, ported from
// data/school/e_data1.txt (easy), e_data2.txt (medium), e_data3.txt
// (difficult). Each word reveals a sentence + picture once guessed.
const WORD_LEVELS = {
  easy: [
